...
CREATE TABLE `filme_ator` (
  ...
  KEY `filme_id_idx` (`filme_id`),
  CONSTRAINT `ator_filme_id` FOREIGN KEY (`filme_id`) REFERENCES `filmes` (`filmes_id`),
  CONSTRAINT `ator_id` FOREIGN KEY (`ator_id`) REFERENCES `ator` (`ator_id`)
